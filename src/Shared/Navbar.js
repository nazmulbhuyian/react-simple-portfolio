...
const Navbar = () => {
    return (
        <div className='bg-slate-800 p-8'>
            <div className=' flex justify-center max-w-[1440px] mx-auto bg-slate-800'>
                <div>
                    <h1>Nazmul Bhuyian</h1>
                </div>
                <div>
                    <Link className='font-medium lg:mx-8 mx-2 hover:text-emerald-500' to='/'>Home</Link>
                    <Link className='font-medium lg:mx-8 mx-2 hover:text-emerald-500' to='/service'>Service</Link>
