...
const Service = () => {
    return (
        <div className='my-16 mx-16 lg:mx-36'>
            ...
            <p className='font-bold text-white mt-3'>I am a skilled react js developer. Always I prefer hand coded organized programming. I am
                ...
                and want to make people's life easy with programming.</p>
            <p className='font-bold text-white mt-3'>
                I am a motivated and hardworking individual who is always looking for new challenges. I
                am confident that I can be a valuable asset to your team and I am excited to learn more
                about the React Developer position. I also completed a full web development course
                from Programming Hero. During my learning experience I built more than 15 projects
                and gained many skills in react js.
            </p>
        </div>
    );
};
